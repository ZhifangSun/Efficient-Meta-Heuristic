...
class newPSOIPPSScheduler(Scheduler):
    ...
    def schedule(self, app,targetms):
        ...
        gLine = pLine = population[0]  # 全局最优解、当前最优解
        best_ans=[]
        ...
        while True:
            ...
            crossover_chromosomes = self.crossover(app,population, pLine, gLine, w, c1, c2)#前后交叉
    ...
    def crossover(self, app, population, pLine, gLine, w, c1, c2):
        ...
        for i in range(0, len(population)):
            ...
            prev_chromosome = []
            next_chromosome = []
            prev_chromosome.extend(parent1.chromosome)
            next_chromosome.extend(parent2.chromosome)
            if ORnum > 0:
